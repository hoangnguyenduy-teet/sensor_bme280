...
#define ERROR_OUT_OF_MEMERY 0x07U // Hết bộ nhớ
#define ERROR_BUFFER_FULL	0x08U // Bộ đệm đầy
#define ERROR_BUFFER_EMPTY	0x09U // Bộ đệm trống
...
#define ERROR_UART_FRAMING		0x22U // Lỗi dữ liệu không đúng định dạng
...
#define ERROR_SPI_OVERRUN 		0x33U // Lỗi overrun (dữ liệu bị ghi đè)
#define ERROR_SPI_BUSY			0x34U // Lỗi SPI đang bận
...
#define CMDLINE_SOFT_RESET_COMMAND 	(6)
